...
//  Pokedex
//
//  Created by BrianCorbin on 2/5/21.
//
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    TeamPokemonNicknameAndGenderView(genders: [swiftDexService.male, swiftDexService.female],
                    ...
                    TeamPokemonMoveSetView(pokemon: teamPokemon.pokemon, firstMove: $teamPokemon.firstMove, secondMove: $teamPokemon.secondMove,
