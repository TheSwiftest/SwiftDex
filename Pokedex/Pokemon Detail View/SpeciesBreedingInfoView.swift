...
struct PokemonBreedingView: View {
    ...
    var body: some View {
        ScrollView {
            VStack {
                Group {
                    SpeciesExtraInfoView(catchRate: pokemon.species!.captureRate, baseHappiness: pokemon.species!.baseHappiness, baseExperience: pokemon.baseExperience, growthRate: pokemon.species!.growthRate!.name, eggCycles: pokemon.species!.hatchCounter, genderRate: pokemon.species!.genderRate)
