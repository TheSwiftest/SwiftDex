...
struct MemberStatsView_Previews: PreviewProvider {
    static var previews: some View {
        MemberStatsView(pokemonStats: Array(SwiftDexService.pokemon(withId: 1)!.stats), nature: SwiftDexService.nature(withId: 1)!, evs: [1, 1, 1, 1, 1, 1], ivs: [1, 1, 1, 1, 1, 1], level: 50)
